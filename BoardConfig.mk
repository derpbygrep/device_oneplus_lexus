...
# Fingerprint
TARGET_SURFACEFLINGER_UDFPS_LIB := //$(DEVICE_PATH):libudfps_extension.lexus
...
BOARD_PREBUILT_DTBIMAGE_DIR := $(PREBUILT_PATH)/prebuilts/
BOARD_PREBUILT_DTBOIMAGE := $(PREBUILT_PATH)/prebuilts/dtbo.img
PRODUCT_COPY_FILES += \
	$(PREBUILT_PATH)/prebuilts/kernel:kernel
