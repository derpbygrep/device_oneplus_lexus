...
# Regional properties
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/recovery/root/vendor/odm/etc/24881/build.EU.prop:$(TARGET_COPY_OUT_ODM)/etc/22877/build.EU.prop \
    $(LOCAL_PATH)/recovery/root/vendor/odm/etc/24881/build.IN.prop:$(TARGET_COPY_OUT_ODM)/etc/22877/build.IN.prop \
    $(LOCAL_PATH)/recovery/root/vendor/odm/etc/24881/build.NA.prop:$(TARGET_COPY_OUT_ODM)/etc/22877/build.NA.prop \
