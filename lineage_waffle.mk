...
PRODUCT_BUILD_PROP_OVERRIDES += \
    BuildDesc="CPH2581EEA-user 15 AP3A.240617.008 U.R4T3.1d8d7d8-3fe7-3973 release-keys" \
    BuildFingerprint=OnePlus/CPH2581EEA/OP595DL1:15/AP3A.240617.008/U.R4T3.1d8d7d8-3fe7-3973:user/release-keys \
    DeviceName=OP595DL1 \
